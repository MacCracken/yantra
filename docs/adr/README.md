...
- [0002 — public API frozen at 0.9.0 for 1.0.0](0002-public-api-frozen-at-0.9.0-for-1.0.0.md) — the 46 public `yantra_*` verbs are the 1.0.0 surface; frozen at 0.9.0, additive-only from 1.0.0 on.
